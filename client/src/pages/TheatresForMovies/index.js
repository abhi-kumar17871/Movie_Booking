      ...
      <div>
        ...
        <div className="mt-2 flex flex-col gap-3">
          {theatres.map((theatre) => (
            <div className="border-2 border-solid border-gray-500 p-2">
              ...
              <div className="flex gap-2">
                {theatre.shows
                  ...
                  .map((show) => (
                    <div
                      className="mt-2 border-2 rounded-md bg-red-500 hover:bg-red-600 border-solid border-gray-500 p-2 cursor-pointer"
                      onClick={() => {
